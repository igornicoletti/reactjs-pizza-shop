...
export const FormVariants = tv({
  slots: {
    ...
    formlist: 'flex items-center justify-between w-full h-12 px-4 rounded-md border border-in-stone hover:border-in-white focus:border-in-cyan bg-transparent focus:outline-none transition ease-in-out duration-300',
    formoptions: 'absolute right-0 w-full flex flex-col p-2 mt-2 rounded-md shadow-lg bg-in-slate focus:outline-none',
    formoption: 'group flex items-center gap-2 p-2 rounded-md hover:bg-in-cyan hover:text-in-dark focus:outline-none transition ease-in-out duration-300',
...
export const DashboardVariants = tv({
  slots: {
    ...
    dashcard: 'flex flex-col p-4 rounded-md bg-in-slate',
    dashcardlt: '2xl:col-span-4 p-4 md:p-6 rounded-md bg-in-slate',
    dashcardrt: '2xl:col-span-2 p-4 md:p-6 rounded-md bg-in-slate',
...
export const ToastVariants = tv({
  slots: {
    ...
    toastpanel: 'pointer-events-auto relative w-full max-w-md flex flex-col gap-1 p-4 rounded-md shadow-lg bg-in-slate border-b-4',
